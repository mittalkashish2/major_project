...
export default class App extends React.Component {
    ...
    submitRegister(e) {
      ...
      for (var i = 0; i < this.state.courses.length; i++){
        if (this.state.feedback[i] !== "" && this.state.feedback[i] !== "1" && this.state.feedback[i] !== "2" && this.state.feedback[i] !== "3" && this.state.feedback[i] !== "4" && this.state.feedback[i] !== "5" ) {
      ...
      if(mres){
        ...
        if(!this.state.courses.length || !cres)request.feedback = ["$"];
        // console.log(request);
